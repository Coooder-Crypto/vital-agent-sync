...
- iOS relay onboarding, encrypted upload, and status-only callback code paths: `App/HealthLinkApp.swift`, `App/GatewayAPIClient.swift`, `App/SyncCoordinator.swift`, and related app files.
